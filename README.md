...
```
git clone https://github.com/blip2311/exemplifi_assignment.git
```

## 2. Change Directory

```
cd assignment_exemplifi
```
...
For any issues, please check the Laravel documentation or contact the project maintainer.
